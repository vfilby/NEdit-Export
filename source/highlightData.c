...
#ifdef VMS
#define N_DEFAULT_PATTERN_SETS 27
#else
#define N_DEFAULT_PATTERN_SETS 28
#endif /*VMS*/
...
/* The VAX C compiler cannot compile this definition */
    ...
    "NEdit Macro:1:0{\n\
	Comment:\"#\":\"$\"::Comment::\n\
	Built-in Vars:\"<\\$([1-9]|column|cursor|em_tab_dist|file_name|file_path|language_mode|n_args|read_status|search_end|selection_end|selection_left|selection_right|selection_start|shell_cmd_status|string_dialog_button|tab_dist|text_length|use_tabs|wrap_margin)>\":::Identifier::\n\
	...
	Keyword:\"<(while|if|else|for|break|continue|return|define)>\":::Keyword::\n\
	Braces:\"[{}]\":::Keyword::\n\
